...
def upgrade():
    ...
    sa.Column('cou_course_id', sa.String(length=10), nullable=True),
    sa.Column('course_name', sa.String(length=100), nullable=True),
    sa.Column('course_description', sa.String(length=1024), nullable=True),
    sa.Column('course_code', sa.String(length=15), nullable=True),
    sa.Column('course_status', sa.String(length=50), nullable=True),
    sa.ForeignKeyConstraint(['cou_course_id'], ['course.course_id'], onupdate='RESTRICT', ondelete='RESTRICT'),
